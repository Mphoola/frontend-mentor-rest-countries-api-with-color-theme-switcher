    ...
    <div class="">
        ...
        <div class="px-6 pt-4">        
            <div class="flex flex-col md:flex-row md:justify-between">
                <!-- search input  -->
                <div class="relative">
                    <input type="text" class="border w-full border-gray-300 pl-12 py-2 focus:outline-none focus:ring-2 focus:ring-gray-600 focus:border-transparent" placeholder="Search for a country..." />
